...
let currentSession: BxSession | null = null;
...
export async function getBxSession(): Promise<string | null> {
...
export async function refreshBxSession(): Promise<string | null> {
  currentSession = null;
